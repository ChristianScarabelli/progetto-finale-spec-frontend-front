...
export default function FoodDetail() {
    ...
    return (
        <section className="mx-auto p-4 pt-[82px] pb-10 bg-green-200 z-0">
            {foodDetail ? (
                <div className="relative flex flex-col gap-3 text-gray-800 bg-gray-50 shadow-lg p-5 rounded-lg mt-10">
                    {/* Cuoricino Favoriti */}
                    <button
                        onClick={() => toggleFavorite(foodDetail)}
                        className="absolute top-4 right-4 text-gray-600 hover:text-cyan-600 transition"
                    >
                        {isFavorite ? (
